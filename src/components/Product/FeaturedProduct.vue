        ...
        <div class="flex mt-10 justify-between">
            <div class="w-4/12 flex flex-col justify-between">
                <div>
                    ...
                    <div class="flex gap-2 mt-3">
                        ...
                        <button class="btn btn-primary rounded-btn btn-sm ml-2">Starting at £{{
                            featuredProduct.startingPrice.toFixed(2) }} (only)</button>
                    </div>
                </div>
                <div class="mt-5">
                    <div class="mt-3">
            ...
            <div class="w-3/12 flex flex-col justify-between">
                <div class="flex gap-2">
                    <img class="rounded-box w-5/12"
                        :src="getImageUrl(featuredProduct.newFeatureImage.imageUrl).toString()" />
                ...
                <div class="flex gap-2">
                    ...
                    <img class="rounded-box w-4/12"
                        :src="getImageUrl(featuredProduct.newFeatureImage2.imageUrl).toString()" />
                </div>
